...
function refreshMyToken(refreshToken){
		    ...
		    onSuccess: function (inResponse) {
		    	 ...
		    	 refTok(device , refreshToken , inResponse["idList"][0]["idValue"]);
 ...
 async function refTok(device , refreshToken , hash){
	    ...
	    let params = {
		        ...
		        "version" : "0.0.1"
		 	   	    ...
		 	   	    var response = await fetch(URL + 'v3/users/auth/renew.php?' +
